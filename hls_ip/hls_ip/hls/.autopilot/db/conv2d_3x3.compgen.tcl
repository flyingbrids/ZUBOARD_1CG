...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv2d_3x3_fifo_w80_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {input_r_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv2d_3x3_fifo_w80_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {output_r_U}
}

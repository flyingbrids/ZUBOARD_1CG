...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_input_r \
    op interface \
    ports { input_r_din { O 80 vector } input_r_num_data_valid { I 3 vector } input_r_fifo_cap { I 3 vector } input_r_full_n { I 1 bit } input_r_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 6
set RegSliceName conv2d_3x3_regslice_both
set RegSliceInstName conv2d_3x3_regslice_both_U
set CoreName ap_simcore_conv2d_3x3_regslice_both
...
set InstName conv2d_3x3_flow_control_loop_pipe_U
set CompName conv2d_3x3_flow_control_loop_pipe

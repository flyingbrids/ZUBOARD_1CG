    ...
    // Process: data_unpacket_U0
    conv2d_3x3_hls_deadlock_detect_unit #(3, 0, 1, 1) conv2d_3x3_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~data_unpacket_U0.input_r_blk_n);
    ...
    // Process: image_filter_U0
    conv2d_3x3_hls_deadlock_detect_unit #(3, 1, 2, 2) conv2d_3x3_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~image_filter_U0.grp_image_filter_Pipeline_VITIS_LOOP_188_2_fu_159.input_r_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~image_filter_U0.output_r_blk_n);
    ...
    // Process: data_packet_U0
    conv2d_3x3_hls_deadlock_detect_unit #(3, 2, 1, 1) conv2d_3x3_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~data_packet_U0.output_r_blk_n);
...
`include "conv2d_3x3_hls_deadlock_report_unit.vh"
